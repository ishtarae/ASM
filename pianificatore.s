...
.section .data
scegli_alg:
    .ascii "Scegli il tipo di algoritmo\nDigita 1 per EDF o 2 per HPF\n"      
scegli_alg_len:
    .long .-scegli_alg
...
msg_error:
    .ascii "Oops, qualcosa è andato storto"
msg_error_len:
    .long .-msg_error
...
_start:                     
    ...
    cmpl $104, %ebx         # flag per controllare se ci sono stati errori nella lettura del file 
    je Error
...
SceltaAlg:
    ...
    movl $0, %ecx                   # azzero registro ECX per poter inserire l'input senza errori
    ...
    jmp pre_scarica_pila                       # salta se non si e' digitato 1 o 2 
